CREATE TABLE "crypto_platform_fee" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "crypto_platform_fee_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
DROP TABLE "user_crypto_platform_fee" CASCADE;